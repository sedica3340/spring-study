...
public class MemberMemoryRepo {
    ...
    public void delete(String account) {
        List<Member> members = memberList.stream().filter(member -> member.getAccount().equals(account))
    ...
    public Member findOne(String account) {
        return memberList.stream().filter(member -> member.getAccount().equals(account))
